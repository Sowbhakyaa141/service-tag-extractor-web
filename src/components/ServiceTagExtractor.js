    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <div className="flex justify-center gap-4 mb-6">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded ${mode === 'upload' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
        >
          <Upload size={20} />
          Upload Image
        </button>
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded ${mode === 'camera' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
        >
          <Camera size={20} />
          Use Camera
        </button>
